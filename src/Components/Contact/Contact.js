    ...
    <div className={classes.Contact} id="Contact">
        <div className={classes.ContactContainer}>
            ...
            <div className={classes.ContactInfo}>
                <p>email: harshnitin.s24@gmail.com</p>
            {/* <div>
            ...
            <div className={classes.SocialLinks}>
                        <a href="https://www.linkedin.com/in/harsh-shah-2404/" target="_blank" rel="noopener noreferrer">
                            <img src={linkedInIcon} className={classes.SocialIcons} alt="LinkedIn"/>
                        </a>
                        <a href="https://github.com/Harsh2404" target="_blank" rel="noopener noreferrer">
                            <img src={githubIcon} className={classes.SocialIcons} alt="GitHub"/>
                        </a>
            </div>
        </div>
    </div>
